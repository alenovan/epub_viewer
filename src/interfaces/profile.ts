...
export interface UserUpdateMutation<T> extends MutationProps<T>, UserUpdate {}
...
export interface UserPasswordUpdateMutation<T> extends MutationProps<T>, UserPasswordUpdate {}

export interface UserPasswordResponse {}

export interface UserUpdateOtp<T> extends MutationProps<T> {}
